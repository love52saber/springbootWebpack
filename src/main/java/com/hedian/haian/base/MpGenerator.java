...
//        dsc.setUrl("jdbc:mysql://106.14.224.216:3306/jiangyin_risk_new?serverTimezone=GMT%2B8&useUnicode=true&characterEncoding=utf-8");
...
//        strategy.setInclude(new String[] {"tbl_risk_hr"}); // 需要生成的表
...
//        pc.setParent("com.hedian.platform.customer.risk");
