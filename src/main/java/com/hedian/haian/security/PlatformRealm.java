...
import com.hedian.haian.util.JWTUtil;
...
* @Description:    Realm用于统一处理用户是否合法这一块

* @Author:         noahw

* @CreateDate:     2019-01-11 9:45
...
public class PlatformRealm extends AuthorizingRealm {
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken auth) throws AuthenticationException {
        ...
        return new SimpleAuthenticationInfo(token, token, "platform_realm");
    }
}
